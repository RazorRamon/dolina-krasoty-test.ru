		...
		<main>
			<div class="breadcrumb">
				<ul>
					...
					<li>
						<a href="#" title="О магазине">О магазине</a>
					</li>
					<li>
						<span>Контакты</span>
					</li>
						...
						<li>
							<div>
								<div class="trading_point">
									...
									<br />
									<h2>ОФИС ИНТЕРНЕТ-МАГАЗИНА</h2>
									<div class="contact_info">
										<p>Россия, 117186, Москва, ул. Нагорная, <br />
										дом 12, корп. 2 </p>

										<p>тел./факс: 8(495)7653432, <br />
										8(495)7653446, (495) 663-1676. </p>

										<p>Телефон горячей линии: 8 800 333-9007 <br />
										(звонок по России бесплатный) </p>

										<p>e-mail: shop@victoryco.ru</p>

										<p>Режим работы: 09.00 - 18.00 пн.-пт. <br />
										выходной сб.-вс. </p>
									</div>
								</div>
								<div class="trading_point">
							...
							<h2 class="rekvizit_title">РЕКВИЗИТЫ КОМПАНИИ</h2>
							<div class="contact_info">
								<p>ОАО "АЛЬФА-БАНК" филиал "Екатеринбургский" <br /><br />
								ИНН 7728168971 <br /><br />
								ОГРН 1027700067328 <br /><br />
								БИК 046577964</p>
							</div>
						</li>
						<li>
