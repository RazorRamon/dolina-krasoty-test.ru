			...
			<div id="news_list">
				...
				<div class="slider_news">
					<div class="cycle-slideshow" data-cycle-prev=".prev" data-cycle-next=".next" data-cycle-fx="scrollHorz" data-cycle-slides="> div" data-cycle-timeout=3000 >
						<div>
							<a href="#"><img src="/images/slide-sale-2.png"></a>
				...
				<div id="catalog_list">
					...
					<div class="tovar-list">
						<ul>
							<li class="box">
								<img src="/images/marker-sale.png" style="position: absolute; width: 56px; height: 39px; top: 15px; left: -6px;" />
