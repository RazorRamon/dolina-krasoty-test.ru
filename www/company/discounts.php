	...
	<body>
		...
		<main>
			...
			<div id="discounts">
				...
				<ul>
					<li class="box">
						<p>Скидки от суммы заказа рассчитываются автоматически:</p>
						<p>&#9679;  от 10000    <span>5%</span></p>
						<p>&#9679;  от 20000    <span>10%</span></p>
						<p>&#9679;  от 35000    <span>15%</span></p>
						<p>&#9679;  от 50000    <span>20%</span></p>
					</li>
					<li class="box">
						<p>Скидка выпускникам УЦ компании "Виктори" - <span>7%</span> (от розничной цены).</p>
						<p><small>Чтобы ввести номер карты выпускника и автоматически получать скидку на продукцию, сообщите в комментариях при регистрации на сайте номер Вашей карты (при следующем входе на сайт, цена товара будет указана со скидкой).</small></p>
					</li>
					<li class="box">
						<p>Интернет-магазин может вводить разовые скидки.</p>
						<a href="#">Следите за новостями</a>
					</li>
					<li class="box">
						<p style="text-indent: 30px;">Важно помнить</p>
						<a class="disabled">Скидки не суммируются</a>
					</li>
				</ul>
