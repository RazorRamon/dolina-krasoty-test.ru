		...
		<main>
			...
			<div id="news_list">
					...
					<div class="cycle-slideshow" data-cycle-prev=".prev" data-cycle-next=".next" data-cycle-fx="scrollHorz" data-cycle-slides="> div" data-cycle-timeout=3000 >
						<div>
							...
							<div class="kalka_slider-news">
								...
								<a href="#" class="h3_title">Новинка которую долго ждали. Гелевые лаки Gelaze!</a>
								Это пример анонса текстового блока, создан для примера. Это пример анонса текстового блока, создан для примера. Это пример анонса текстового блока, создан для примера.
							</div>
						</div>
						<div>
							<a href="#"><img src="/images/slide-news-1.png"></a>
				...
				<div class="block_news-element-right">
					...
					<div class="text_block">Встречайте GELAZE от China Glaze - абсолютно новое и уникальное покрытие с формулой 2-в-1, которое изменит ваше 
представление об идеальном маникюре (Gelaze - джилэ'йз).<br /><br />Специальные компоненты, которые входят в состав покрытия GELAZE Gel-n-Base in One, позволяют... <a href="#">&#9658;</a></div>
				</div>
				...
				<div class="block_news-element-wide">
					...
					<div class="text_block">
						...
						Встречайте GELAZE от China Glaze - абсолютно новое и уникальное покрытие с формулой 2-в-1, которое изменит ваше представление об идеальном маникюре (Gelaze - джилэ'йз).<br /><br />Специальные компоненты, которые входят в состав покрытия GELAZE Gel-n-Base in One, позволяют... <a class="more" href="#"><img src="/images/news-list-element-more.png"></a>
					</div>
				</div>
				<div class="block_news-element-wide">
					<div class="date"><span>21</span>11.14</div>
